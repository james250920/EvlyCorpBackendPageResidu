...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseNpgsql("Host=localhost;Port=5433;Database=residu;Username=postgres;Password=sistemas", x => x.UseNodaTime());
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Condominiums>(entity =>
        {
            ...
            entity.Property(e => e.BoardMembers)
                .HasColumnType("jsonb")
                .HasColumnName("board_members");
            entity.Property(e => e.CreatedAt)
                .HasDefaultValueSql("CURRENT_TIMESTAMP")
                .HasColumnType("timestamp(3) without time zone")
                .HasColumnName("created_at");
            ...
            entity.HasOne(d => d.Municipality).WithMany(p => p.Condominiums)
                ...
                .HasConstraintName("condominiums_municipality_id_fkey");

            entity.HasOne(d => d.Representative).WithMany(p => p.Condominiums)
                .HasForeignKey(d => d.RepresentativeId)
                .HasConstraintName("condominiums_representative_id_fkey");
        });
